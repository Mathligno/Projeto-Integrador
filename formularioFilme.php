...
?>
        <div class="container pag">
            ...
            <div class="mb-3">
                    <label for="idfilme" class="form-label"></label>
                    <input type="hidden" class="form-control" id="idfilme" name="idfilme">
                </div>
                <div class="mb-3">
                    <label for="titulo" class="form-label">Título</label>
                    <input type="text" class="form-control" placeholder="Informe o Título do Filme" id="titulo" name="titulo" required>
                </div>
                <div class="mb-3">
                ...
                <div class="row">
                    <div class="col text-start">
                        <a href="listarFilme.php"> <button type="button" class="btn btn-success btn-sm">VOLTAR</button> </a>
                    </div>
