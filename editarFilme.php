    <body class="body1">
            ...
            <form name="form" method="post" action="updateFilme.php">
                ...
                <div class="row mt-5">
                    <div class="col text-start">
                        <a href="listarFilme.php"> <button type="button" class="btn btn-warning btn-sm">VOLTAR</button> </a>
                    </div>      
        ...
        <script src="https://cdn.jsdelivr.net/npm/bootst.0/dist/js/bootstrap.bundle.min.js" integrity="sha384-A3rJD856KowSb7dwlZdYEkO39Gagi7vIsF0jrRAoQmDKKtQBHUuLZ9AsSv4jD4Xa" crossorigin="anonymous"></script>
        <?php
            }
            else{
                echo "
                    <p> Esta é uma página de tratamento de dados. </p>
                    <p> Clique <a href='listarFilme.php'>aqui</a> para selecionar um Usuário. </p>
                ";   
            }
        ?>
        <br><br><br>
